...
# JSX is a JavaScript syntax which is easier to create react element. JSX is not part of the react both are separate. we can write react without jsx also. we can create complex application but jsx makes developer life easy. that's why we use jsx
...
# babel understand this jsx component by angle bracket. Element will be wrapped by angle bracket so it will be react component.
