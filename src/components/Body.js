                ...
                <div className='mx-auto w-[90%]'>
                    <div className='flex items-center'>
                        <div className='p-2 m-2'>
                            ...
                            }} className='border border-solid black-border p-2 rounded-md' value={searchText} />
                            <button className='ml-2 bg-pink-200 border p-2 rounded-md' onClick={() => {
                        ...
                        <div>
                            <button className='border border-solid black-border p-2 rounded-md bg-pink-200 ' onClick={() => {
                    ...
                    <div className='flex flex-wrap'>
                        {filteredRes?.map((restaurant) => {
                            return <Link to={"/restaurant-menu/" + restaurant.info.id} key={restaurant.info.id}> 
                                {false?<CardWithPromoted restList={restaurant}/>:<Card restList={restaurant} />}
                            </Link>;
                        })}
                    </div>
                </div>
